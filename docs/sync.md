...
Implementation: `com.bluetalk.android.sync.PacketIdUtil`.

## GCS Filter (On-demand)

Implementation: `com.bluetalk.android.sync.GCSFilter`.
...
Encode/Decode implementation: `com.bluetalk.android.model.RequestSyncPacket`.
