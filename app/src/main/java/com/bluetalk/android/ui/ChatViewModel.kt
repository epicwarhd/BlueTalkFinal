...
import com.bluetalk.android.util.NotificationIntervalManager
...
import com.bluetalk.android.util.dataFromHexString
import com.bluetalk.android.util.hexEncodedString
...
class ChatViewModel(
    ...
    val selectedLocationChannel: StateFlow<com.bluetalk.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.bluetalk.android.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.bluetalk.android.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.bluetalk.android.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.bluetalk.android.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.bluetalk.android.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.bluetalk.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.bluetalk.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.bluetalk.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.bluetalk.android.geohash.ChannelID.Mesh) {
        ...
        com.bluetalk.android.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.bluetalk.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.bluetalk.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.bluetalk.android.nostr.NostrSubscriptionManager
                val identity = com.bluetalk.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.bluetalk.android.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.bluetalk.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.bluetalk.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.bluetalk.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.bluetalk.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.bluetalk.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.bluetalk.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.bluetalk.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.bluetalk.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.bluetalk.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.bluetalk.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.bluetalk.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.bluetalk.android.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            com.bluetalk.android.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.bluetalk.android.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.bluetalk.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    fun selectLocationChannel(channel: com.bluetalk.android.geohash.ChannelID) {
