...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.bluetalk.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.bluetalk.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.bluetalk.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.bluetalk.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.bluetalk.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.bluetalk.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.bluetalk.android.ui.debug.DebugSettingsSheet(
