...
import com.bluetalk.android.nostr.GeohashMessageHandler
import com.bluetalk.android.nostr.GeohashRepository
import com.bluetalk.android.nostr.NostrDirectMessageHandler
import com.bluetalk.android.nostr.NostrIdentityBridge
import com.bluetalk.android.nostr.NostrProtocol
import com.bluetalk.android.nostr.NostrRelayManager
import com.bluetalk.android.nostr.NostrSubscriptionManager
import com.bluetalk.android.nostr.PoWPreferenceManager
import com.bluetalk.android.nostr.GeohashAliasRegistry
import com.bluetalk.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.bluetalk.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.bluetalk.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.bluetalk.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.bluetalk.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                if (startedMining) {
                    com.bluetalk.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.bluetalk.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.bluetalk.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    private fun switchLocationChannel(channel: com.bluetalk.android.geohash.ChannelID?) {
