...
class PeerManager {
    ...
    private val stalePeerTimeoutMs: Long = com.bluetalk.android.util.AppConstants.Mesh.STALE_PEER_TIMEOUT_MS
    ...
    private fun startPeriodicCleanup() {
        managerScope.launch {
            while (isActive) {
                delay(com.bluetalk.android.util.AppConstants.Mesh.PEER_CLEANUP_INTERVAL_MS)
                cleanupStalePeers()
            }
        }
    }
