 ...
 * 
 * This class handles all relay decisions and logic for bluetalk packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.bluetalk.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
