...
object VerificationService {
    private const val CONTEXT = "bluetalk-verify-v1"
    private const val RESPONSE_CONTEXT = "bluetalk-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "bluetalk" || uri.host != "verify") return null
