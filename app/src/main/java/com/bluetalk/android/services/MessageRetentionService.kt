...
//
//    suspend fun saveMessage(message: BlueTalkMessage, forChannel: String) = withContext(Dispatchers.IO) {
...
//    }
//
//    suspend fun loadMessagesForChannel(channel: String): List<BlueTalkMessage> = withContext(Dispatchers.IO) {
...
//    }
//
//    private fun loadMessagesFromFile(file: File): List<BlueTalkMessage> {
//        if (!file.exists()) {
//            return emptyList()
//        }
//
...
//                    ois.readObject() as List<BlueTalkMessage>
//                }
//            }
//        } catch (e: Exception) {
...
//    }
//
//    private fun saveMessagesToFile(file: File, messages: List<BlueTalkMessage>) {
