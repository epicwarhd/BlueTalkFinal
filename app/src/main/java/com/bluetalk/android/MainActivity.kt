...
import com.bluetalk.android.onboarding.BluetoothCheckScreen
import com.bluetalk.android.onboarding.BluetoothStatus
import com.bluetalk.android.onboarding.BluetoothStatusManager
import com.bluetalk.android.onboarding.BatteryOptimizationManager
import com.bluetalk.android.onboarding.BatteryOptimizationPreferenceManager
import com.bluetalk.android.onboarding.BatteryOptimizationScreen
import com.bluetalk.android.onboarding.BatteryOptimizationStatus
import com.bluetalk.android.onboarding.BackgroundLocationPermissionScreen
import com.bluetalk.android.onboarding.InitializationErrorScreen
import com.bluetalk.android.onboarding.InitializingScreen
import com.bluetalk.android.onboarding.LocationCheckScreen
import com.bluetalk.android.onboarding.LocationStatus
import com.bluetalk.android.onboarding.LocationStatusManager
import com.bluetalk.android.onboarding.OnboardingCoordinator
import com.bluetalk.android.onboarding.OnboardingState
import com.bluetalk.android.onboarding.PermissionExplanationScreen
import com.bluetalk.android.onboarding.PermissionManager
import com.bluetalk.android.ui.ChatScreen
import com.bluetalk.android.ui.ChatViewModel
import com.bluetalk.android.ui.OrientationAwareActivity
import com.bluetalk.android.ui.theme.BlueTalkTheme
import com.bluetalk.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.bluetalk.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.bluetalk.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.bluetalk.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.bluetalk.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.bluetalk.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.bluetalk.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.bluetalk.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.bluetalk.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.bluetalk.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.bluetalk.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.bluetalk.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.bluetalk.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.bluetalk.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.bluetalk.android.geohash.GeohashChannelLevel.REGION
                        else -> com.bluetalk.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.bluetalk.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.bluetalk.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "bluetalk" || uri.host != "verify") return
