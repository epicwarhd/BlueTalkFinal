...
class SecurityManagerTest {
    ...
    fun `validatePacket - handles ANNOUNCE duplicates correctly`() {
        ...
        val packet2 = packet1.copy(ttl = (com.bluetalk.android.util.AppConstants.MESSAGE_TTL_HOPS - 1u).toUByte())
        ...
        val packet3 = packet1.copy(ttl = com.bluetalk.android.util.AppConstants.MESSAGE_TTL_HOPS)
