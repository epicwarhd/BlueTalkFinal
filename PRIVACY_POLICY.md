...
bluetalk is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how bluetalk protects your privacy.
...
- **Hybrid Functionality** - bluetalk offers two modes of communication:
...
## What Information bluetalk Stores
...
During each session, bluetalk temporarily maintains:
...
### With Other bluetalk Users

When you use bluetalk, nearby peers can see:
...
To provide the core functionality of bluetalk, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other bluetalk peers nearby for the "Bluetooth Mesh Chat" mode.
...
bluetalk does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
bluetalk is an open source project. For privacy questions:
- Review our code: https://github.com/yourusername/bluetalk
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. bluetalk proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like bluetalk itself.*